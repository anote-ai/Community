...
function ArmorAgentRegistry() {
  ...
  },
  {
   ...
   },
   {
     ...
     "title": "Document Processing for Business",
   ...
   },
   {
     ...
     "title": "Time Tracking for Business Hours",
  ...
  const categories = ["Creator", "Education", "Analyze", "Automate", "Code", "Productivity", "Business"];
  ...
  return (
    ...
    {filteredAgents.length > 0 ? (
      filteredAgents.map((agent, index) => (
        <div
          key={index}
          className="bg-gray-800 border border-gray-700 rounded-3xl shadow-lg overflow-hidden transform transition-transform hover:-translate-y-3 hover:shadow-xl cursor-pointer group"
        ...
        >
          <div className="relative w-full h-40 overflow-hidden">
            ...
            {/* The FaPlay Icon (always centered on hover) */}
      ...
      {isModalOpen && selectedAgent && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-70 z-50 backdrop-blur-md">
          <div className="bg-gray-900 w-11/12 md:w-3/4 lg:w-1/2 rounded-3xl p-10 text-white relative max-h-[90vh] overflow-y-auto border border-[#2a2a2a] shadow-2xl">
            <button
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-3 text-gradient bg-[#defe47] bg-clip-text text-transparent">
                About
              </h2>
            ...
            {selectedAgent.metrics && selectedAgent.metrics.length > 0 && (
              <section className="mb-8">
                <h3 className="text-2xl font-semibold mb-3 text-gradient bg-[#defe47] bg-clip-text text-transparent">
                  Key Metrics
                </h3>
            ...
            <a
              ...
              className="block w-full text-center bg-[#defe47] text-black px-6 py-3 rounded-full font-semibold text-lg hover:scale-105 transition-transform"
            >
              Try Agent
            </a>
          </div>
...
export default ArmorAgentRegistry;
