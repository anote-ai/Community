...
function SummerParty() {
  const [formData, setFormData] = useState({
    ...
    email_address: "",
    linkedin_url: "",
    event_sheet: "Summer Party",
    event_title: "Anote Summer Team Party",
    event_date: "8/7/2026",
  ...
  return (
    <div className="w-screen bg-gray-900 text-white flex items-center justify-center">
      <SEO
        ...
        description="Anote's Summer Team Party celebrating the Research Fellowship in New York City."
        path="/summerparty"
        jsonLd={{
      ...
      <div className="w-screen bg-gray-900 text-white flex flex-col items-center justify-center px-6 py-8">
        ...
        <div className="registration-container bg-gray-800 p-8 rounded-lg shadow-lg w-full max-w-lg mx-4 mb-4">
          {isLoading ? (
            ...
            <>
              <h2 className="text-3xl font-bold mb-4 text-center">Summer Party Registration</h2>
