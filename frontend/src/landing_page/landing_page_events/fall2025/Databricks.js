...
function Databricks() {
  ...
  const [formData, setFormData] = useState({
    ...
    email_address: "",
    linkedin_url: "",
    event_sheet: "Databricks",
    event_title: "Databricks / Sigma Computing / Anote AI Meetup",
    event_date: "10/23",
    event_time: "6 PM EST to 9 PM EST",
    event_dateTimeStart: "2025-10-23T18:00:00-04:00",
    event_dateTimeEnd: "2025-10-23T21:00:00-04:00",
    event_location: "124 e 14th street"
  });
  ...
  const scriptURL = "https://script.google.com/macros/s/AKfycby7zQ3c6n9oRXkYL2IW4ctmZNgSLShsyHKgpec7x_kufmO74VHG7Qbp91H9Dtrhq5LsCw/exec"; // Replace with your Web App URL
  ...
  <div className="w-screen bg-gray-900 text-white flex items-center justify-center">
    <div className="w-screen bg-gray-900 text-white flex flex-col items-center justify-center px-6 py-8">
      <h1 className="text-3xl md:text-5xl font-bold mb-8 text-center">
        Databricks / Anote Fall AI Meetup
      </h1>
      ...
      <p className="text-gray-300">Please wait while we confirm your registration.</p>
          ...
          <>
            ...
            <p className="text-sm text-gray-400 mb-6 text-center">
              Join our waitlist for the Databricks / Anote Fall AI Meetup.
            </p>
