      ...
      <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
            ...
            <li className="mb-3">
              <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                <img
                  ...
                  loading="lazy"
                />
                <span className=" text-2xl text-white font-semibold font-['Arial']">
                  Anote
                </span>
              </a>
            </li>
        ...
        <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
          <div className="lg:w-1/5 md:w-1/2 w-full px-4">
            <h2 className="font-medium text-yellow-500 text-base lg:text-xl mb-3 font-['Arial']">
              Products
            </h2>
            <nav className="list-none mb-10">
              <li className="mb-3">
              ...
              <li className="mb-3">
                <a
                  className="text-gray-300 hover:text-turquoise-300 hover:cursor-pointer"
                  href="https://anote.ai/downloadprivategpt"
                  target="_blank"
                >
                  Private Chatbot
                </a>
